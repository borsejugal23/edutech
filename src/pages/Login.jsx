  ...
  return (
    <DIV>
      <div className="background">
        <img
          width={"100%"}
          src="https://images.unsplash.com/photo-1564981797816-1043664bf78d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
          alt=""
        />
      </div>
      ...
      <div className="signup-page">
        <div className="signup-detail">
          ...
          />
          <h3>
            Login using your credential and get benifited <br />
            to study in the dream universities <br /> with the career mantra's
            support !
          </h3>
        </div>
        <div className="signup">
          <h1>
            Career<span>Mantra</span> <span> Login</span>
          </h1>
          ...
          <span>
            ...
            <Link className="log-btn" to="/sign-up">
              SignUp
            </Link>{" "}
          </span>
        </div>
