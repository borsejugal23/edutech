      ...
      <div style={{ width: "90%", margin: "auto", marginTop: "50px" }}>
        <SimpleGrid columns={[2, 3, 4]} spacing={10}>
          ...
          <Box>
            ...
            <p style={{ fontSize: "12px", fontFamily: "sans-serif" }}>
              scholarshipinternational.com
            </p>
            <p style={{ fontSize: "12px", fontFamily: "sans-serif" }}>
              schoolinternational.com
            </p>
          </Box>
          <Box>
            <h2 style={{ fontFamily: "sans-serif", fontWeight: "bolder" }}>
              College Finder Group
            </h2>
            <u
              style={{
                fontSize: "12px",
            ...
            >
              <Link to="https://studyinternational.com/">
                studyinternational.com
              </Link>
            </u>
            <p style={{ fontSize: "12px", fontFamily: "sans-serif" }}>
            ...
            >
              <Link to="https://sell.sawbrokers.com/domain/CollegeInternational.com/">
                collegeinternational.com
              </Link>
            </u>
          </Box>
          <Box>
