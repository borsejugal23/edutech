    ...
    <div className="sidebar">
      <div>
        <div className="postion">
          <p style={{ fontSize: "20px", marginTop: "3px" }}>
            {" "}
            <HiFilter />
          </p>
        </div>
        ...
        <div>
          <Text fontSize="lg" className="testing">
            Category
          </Text>
          <Stack pl={6} mt={1} spacing={1}>
            <Checkbox
              value={"university"}
              isChecked={category.includes("university")}
            ...
            <Checkbox
              value={"school"}
              isChecked={category.includes("school")}
              onChange={filterByCategory}
            >
              School
            </Checkbox>
        ...
        <div>
          ...
          <Stack pl={6} mt={1} spacing={1}>
            <Checkbox
              value={"India"}
              isChecked={country.includes("India")}
              onChange={filterByContry}
            >
              India
            </Checkbox>
            <Checkbox
              value={"USA"}
              isChecked={country.includes("USA")}
              onChange={filterByContry}
            >
              USA
            </Checkbox>
            ...
            <Checkbox
              value={"Japan"}
              isChecked={country.includes("Japan")}
              onChange={filterByContry}
            >
              Japan
            </Checkbox>
        ...
        <div>
          ...
          <Stack pl={6} mt={1} spacing={1}>
            <Checkbox
              value={"Pasadena"}
              isChecked={city.includes("Pasadena")}
            ...
            <Checkbox
              value={"Cambridge"}
              isChecked={city.includes("Cambridge")}
              onChange={filterByCity}
            >
              Cambridge
            </Checkbox>
            ...
            <Checkbox
              value={"Nashik"}
              isChecked={city.includes("Nashik")}
              onChange={filterByCity}
            >
              Nashik
            </Checkbox>
            <Checkbox
              value={"Bangalore"}
              isChecked={city.includes("Bangalore")}
              onChange={filterByCity}
            >
              Bangalore
            </Checkbox>
        ...
        <div>
          ...
          <Stack pl={6} mt={1} spacing={1}>
            <Checkbox
              value={"private"}
              isChecked={ownership.includes("private")}
              onChange={filterByOwnership}
            >
              Private
            </Checkbox>
            <Checkbox
              value={"Government"}
              isChecked={ownership.includes("Government")}
              onChange={filterByOwnership}
            >
              Government
            </Checkbox>
